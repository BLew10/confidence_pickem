...
const WeekDisplay = (props) => {
    ...
    useEffect(() => {
        // axios.get(`https://api.sportradar.us/nfl/official/trial/v7/en/games/2022/REG/${currWeek}/schedule.json?api_key=wvt4t5gk8ynbr6ysc2ydxp5s`) // for a week games
    ...
    return games ? (
        <div className='my-5'>
            <h1 className='text-center text-2xl mx-auto my-5'> Week <select name="weekNumber" onChange={(e) => handleWeekChange(e)}>
    ...
    ) : <p className='animate-bounce text-center my-10 text-2xl'><svg class="animate-spin h-5 w-5 mr-3 ..." viewBox="0 0 24 24">
    </svg>LOADING</p>
}
